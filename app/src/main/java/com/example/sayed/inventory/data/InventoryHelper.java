...
import com.example.sayed.inventory.data.InventoryContract.StocksEntry;
    ...
    //كلاس مساعد قواعد البيانات به 2 مثد لانشاء قواعد البيانات ورقم نسخة الفرجن
public class InventoryHelper extends SQLiteOpenHelper {
    ...
    //مثد لانشاء قواعد البيانات
     //SQLiteDatabase هو ف الواقع كلاس يقوم بقراءة البيانات من قواعد البيات او الكتابة عليها
    @Override
    public void onCreate(SQLiteDatabase db) {
        //انشاء String الذي يحتوي علي جمل قواعد البيانات لانشاء جدول قواعد البيانات
    ...
    //مثد لتحديث نسخة قواعد البيانات عند تحديث قواعد البيانات
    @Override
