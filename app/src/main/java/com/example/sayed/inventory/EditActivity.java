...
public class EditActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //كيف يتم تحويل نشاط اضافة عنصر جديد الي نشاط نعديل بيانات العنصر
        //لاحظ ان الفرق بين نشاط الاضافة والتعديل هو ان العنصر الحالي يحتوي علي uri بينما الجديد لا
        Intent intent = getIntent();
        mCurrentProductionUri = intent.getData();
        if (mCurrentProductionUri == null) {
            setTitle("Add a product");
            textView.setText("Add information about production.");
            //واخفاء قائمة حذف منتج اذ ليس من المنطقي حذف منتج لم يتم تسجيله بعد
            invalidateOptionsMenu();
        } else {
            setTitle("Edit product");
            textView.setText("This is the information about a production.");
