...
public class InventoryProvider extends ContentProvider {
    ...
    // المطابق UriMatcher يستخدم لتحديد اي مسار سنسلكه في التفاعل مع قاعدة البيانات
    ...
    //بترجع int برقم الصف او اجدول الذي تم حذفه
    @Override
    ...
    private int updateInventory(Uri uri, ContentValues values, String selection,
        ...
        //لو كان تم تمثيل عمود باسم production راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم PRICE راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم QUANTITY راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم WEIGHT راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم DEALER راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم DESCRIPTION راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم PHOTO راجع علي قيمتة فارغة ولا لا
    ...
    private int updateCustomers(Uri uri, ContentValues values, String selection,
                                String[] selectionArgs) {
        //لو كان تم تمثيل عمود باسم CUSTOMER_NAME راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم CUSTOMER_ADDRESS راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم CUSTOMER_PHONE راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم CUSTOMER_NOTES راجع علي قيمتة فارغة ولا لا
    ...
    private int updateDocuments(Uri uri, ContentValues values, String selection,
                                String[] selectionArgs) {
        //لو كان تم تمثيل عمود باسم CUSTOMER  راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم PRODUCT  راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم  DEBIT راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم  CREDIT راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم  REBATE راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم AMOUNT راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم DATE راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم NOTES راجع علي قيمتة فارغة ولا لا
    ...
    private int updateSuppliers(Uri uri, ContentValues values, String selection,
                                String[] selectionArgs) {
        //لو كان تم تمثيل عمود باسم Suppliers  راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم  NUMBER_UNITS راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم TOTAL_BALANCE راجع علي قيمتة فارغة ولا لا
    ...
    private int updateStock(Uri uri, ContentValues values, String selection,
                                String[] selectionArgs) {
        //لو كان تم تمثيل عمود باسم Stock  راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم  UNIT_PRICE راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم  SELLING_PRICE راجع علي قيمتة فارغة ولا لا
        ...
        //لو كان تم تمثيل عمود باسم  StocksEntry راجع علي قيمتة فارغة ولا لا
