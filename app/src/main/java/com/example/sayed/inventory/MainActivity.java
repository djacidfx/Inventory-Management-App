...
public class MainActivity extends AppCompatActivity
    ...
    public void editProduct(View view){
        ...
        startActivity(intent);
        Toast.makeText(this, "press product to edit it", Toast.LENGTH_LONG).show();
    }
    ...
    public void excel(View view){
        ...
        String[] colors = {"Customers ", "  Suppliers  ", " Stocks"};
        ...
        builder.setItems(colors, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(which == 0){
                    ...
                    Toast.makeText(getApplicationContext(), "check your storage file name is Customers reports.csv",
                    ...
                    Toast.makeText(getApplicationContext(), "check your storage file name is Suppliers reports.csv",
                            Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(getApplicationContext(), "check your storage file name is Stocks reports.csv",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Main_Menu) {
            ...
            Intent intent = new Intent(MainActivity.this, InventoryActivity.class);
            startActivity(intent);
            Toast.makeText(this, "press any production to edit", Toast.LENGTH_LONG).show();
